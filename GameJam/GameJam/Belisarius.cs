...
namespace GameJam
{
    class Belisarius : WorldBuilder
    {
        ...
        public override List<Area> buildWorld(GameState state, Player player)
        {
            ...
            //Enemies
            Enemy giantIsopod = new Enemy("A nearly half meter long crustacean similar in appearance to a pill bug.", new List<string>(new string[] { "isopod" }), "Giant Isopod", "You see a giant isopod scuttling about.", "The isopod waves it's antennae and front legs at you.", 2, Item.sharp, Demeanor.indifferent, inStrength: 3);
